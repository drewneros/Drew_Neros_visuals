...
function useClock({ format = "24h", seconds = true, city = "Belgrade" }){
  ...
  // Approximate timezone offsets for the cities we expose
  const cityMap = {
...
function Sidebar({ tweaks, setTweak, onNav, current, onOpenAdmin, slideIn = true }){
  ...
  const cities = ["Sydney","Melbourne","NYC","LA","London","Paris","Lisbon","Belgrade","Tokyo","Dubai","Bali"];
