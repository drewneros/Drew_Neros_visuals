// Hero section — kept for reference but not mounted in the current layout.
// The Intro component now serves as the hero; when the overlay slides up
// the Work gallery is revealed directly underneath.
